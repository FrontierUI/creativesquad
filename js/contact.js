...
function ContactMap() {
  if (jQuery('#map_canvas').length > 0) {
    var latlng = new google.maps.LatLng(21.6275381333975, 39.135597125416396);
    var settings = {
      zoom: 14,
      center: new google.maps.LatLng(21.6275381333975, 39.135597125416396),
    ...
    var map = new google.maps.Map(
      document.getElementById('csquad_map_canvas'),
      settings
    );
